...
class LayoutProduto extends StatelessWidget {
  ...
  final Function(String nome, String precoCompra, String precoVenda)
      accaoAoFinalizar;

  late ProdutosC _c;
  Produto? produto;

  late String nome, precoCompra, precoVenda;
  ...
  LayoutProduto({this.produto, required this.accaoAoFinalizar}) {
    ...
    if (produto != null) {
      ...
      precoVenda =
          "${produto!.listaPreco!.isEmpty ? 0 : produto!.listaPreco![0]}";
    } else {
      nome = "";
      precoCompra = "";
      precoVenda = "";
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CampoTexto(
              ...
              metodoChamadoNaInsersao: (String valor) {
                ...
                _observadorButoes.mudarValorFinalizarCadastroInstituicao([
                  ...
                  _observadorCampoTexto3.valorPrecoValido.value,
                ]);
              },
            ),
            Obx(() {
            ...
            Obx(() {
              return _observadorCampoTexto3.valorPrecoValido.value == true
                  ? Container()
                  : LabelErros(
                      sms: "Preço de Venda inválido!",
                    );
            }),
            const SizedBox(
              height: 10,
                  ...
                  return Container(
                    ...
                    child: ModeloButao(
                      ...
                      metodoChamadoNoClique: () {
                        accaoAoFinalizar(nome, precoCompra, precoVenda);
                      },
                    ),
                  );
                }),
